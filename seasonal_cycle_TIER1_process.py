...
for station in list_station:
  ...
  data2.plot(y="meas",ax=ax,label="Obs",color="k",linewidth=2,linestyle="--")
  ...
  data4.plot(y="meas",ax=ax,label="Net",color="dimgrey",linewidth=2)
  ...
  plt.savefig('/home/users/mremaud/PYTHON/COS/TRANSCOM/FIG/TIER1_CycleS_process_'+station+'.png',format='png', bbox_inches='tight', dpi = 200)

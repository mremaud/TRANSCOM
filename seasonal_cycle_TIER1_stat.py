...
Aim: Draw subplots for the TIER1 outputs:
 Top : Bar plot of the amplitudes for each model
 Bottom: Month for which the simulated and observed COS values are minimum 
"""
import pandas as pd
import numpy as np
import os
...
#Where to save the figu
dir_fig="/home/users/mremaud/PYTHON/COS/TRANSCOM/FIG/TIER1_CycleS.png"
...
CycleS2=CycleS[(CycleS.model!="OBS")&(CycleS.flux=="SIB4")]

sn.swarmplot(data=CycleS2, x="station", y="Amplitude",hue="model",palette=markers,ax=axes[0])
PROPS = {
...
sn.boxplot(x='station',y='Amplitude',
            data=CycleS2,
            showfliers=False,
            linewidth=0.75, 
            **PROPS,ax=axes[0])
...
sn.swarmplot(data=CycleS2, x="station", y="MonthMin",hue="model",palette=markers,ax=axes[1])
...
plt.savefig(dir_fig,format='png', bbox_inches='tight', dpi = 200)
